...
fn topics() -> Vec<Topic> {
    ...
    vec![
        ...
        Topic { icon: "robot", title: "agents & lead mode", app: "agents", items: vec![
            ...
            Gap,
            H("your own tasks, run together (no lead)"),
            K("space", "mark TODO tasks (numbered in the order you mark them)"),
            K("enter", "run the marked: p all at once (highest priority first) · s one after another"),
