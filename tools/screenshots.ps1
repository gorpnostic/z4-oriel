...
cargo test agents_lead_snapshots
if ($LASTEXITCODE) { throw "lead snapshot test failed" }
Copy-Item target\snap\agents-lead-watch.html docs\screenshot-lead.html -Force
